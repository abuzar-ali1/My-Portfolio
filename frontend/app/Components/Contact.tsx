    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        >
          ...
          <h2
            style={{ color: "#030303" }}
            className="text-4xl sm:text-6xl font-bold  tracking-tight leading-none"
          >
            Let&apos;s
          ...
          >
            <div className="mb-10">
              ...
              <p className="text-slate-500">
                I typically respond within 4 business hours.
              </p>
            </div>
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    className={cn(
                      ...
                      focusedField === "name" &&
                        "border-[#0077B5] bg-white ring-4 ring-[#0077B5]/5",
                    )}
                  />
                </div>
                <div className="space-y-2">
              ...
              {[
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-lg font-bold text-slate-900 group-hover:text-[#0077B5] transition-colors">
                      {item.value}
                    </p>
                  </div>
                </motion.a>
