...
export const PROJECTS = [
  {
    id: 0,
    title: "GitSmart | AI Repo Intelligence",
    description:
      "An AI-powered engine that analyzes GitHub repositories to generate deep architectural insights and codebase health reports.",
    tech: ["Next.js", "Django", "Python", "Llama 3", "PostgreSQL"],
    github: "https://github.com/abuzar-ali1/Git-Smart",
    liveLink: "https://git-smart-steel.vercel.app",
    image: "/Images/git_smart.png",
    icon: Brain, 
  },
  {
    id: 1,
    ...
    description:
      "A high-performance dashboard for visualizing repository metrics and commit history using GitHub APIs.",
...
export const roles = [
  ...
  { title: "React & Next.js", icon: Layout },
  { title: "Python Developer", icon: Terminal },
  { title: "Django Developer", icon: Sparkles },
];
...
export const SKILLS = [
  ...
  {
    name: "Backend",
    items: ["Python", "Django", "REST APIs", "PostgreSQL", "Flask"],
  },
...
export const TIMELINE = [
  {
    ...
    description:
      "Awarded a Google Chromebook by the CM of Sindh for being the Top Performer in Python Development.",
    type: "achievement",
    icon: Award,
  ...
  },
  {
    ...
    institution: "xWave",
    description:
      "One-year intensive fellowship. Selected as top 120 from 500+ applicants.",
    type: "certification",
    icon: Code,
  ...
  },
  {
    ...
    institution: "Sukkur IBA University",
    description:
      "Professional training in OOP, REST APIs, and Machine Learning algorithms.",
    type: "certification",
    icon: Terminal,
...
export const NAV_LINKS = [
  ...
  {name : "Ask Portfolio", href : "#ask_portfolio"},
